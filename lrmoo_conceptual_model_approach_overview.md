Durante el estudio de los modelos conceptuales, observamos que LRMoo ofrece dos posibles enfoques o perspectivas a seguir al momento de mapear los datos.

Enfoque 1

F1 Work — R80 Performed (performed in) — F31 Performance

Esta relación se basa en la propiedad R80 Performed (performed in), que vincula las ideas contenidas en una creación intelectual o artística con el acto de ejecutar dichas ideas. A nuestro juicio, esto contradice el enfoque analítico promovido por estos modelos conceptuales, reduciendo el valor semántico que potencialmente puede asignarse al patrimonio cultural.
Los estudios sobre el significado de Work en diferentes modelos conceptuales (FRBRoo, LRMoo, etc.) respaldan inicialmente la lógica de una posible relación entre Work y Performance. Sin embargo, también afirman que Work no puede crearse sin una Expression y una Manifestation.
Esto plantea la pregunta: ¿cómo puede Performance estar directamente relacionada con Work sin pasar por Expression y Manifestation?
Además, en las artes escénicas, Performance y Manifestation pueden incluso considerarse equivalentes. Si estos modelos conceptuales han de servir como referencia para todo tipo de patrimonio, incluidas las artes “efímeras”, tales cuestiones deberían reconsiderarse.
...
El segundo enfoque se basa en el uso de las clases WEMI, que constituyen el núcleo del modelo y la base de las ontologías construidas sobre él.
Por ejemplo, en una obra de danza (F1 Work), los roles como coreógrafo o compositor musical están vinculados a la creación intelectual, mientras que los intérpretes, como bailarines o músicos, están asociados a la realización de la Expression.
Esta distinción sigue las definiciones de F1 Work como la idea conceptual de la obra, y de F2 Expression como una realización más concreta pero inmaterial de esa idea.
Así, F1 Work abarca las ideas fundamentales de una pieza (lo que el coreógrafo y el compositor desean transmitir), mientras que F2 Expression representa el momento en que esas ideas se comunican a intérpretes específicos, quienes crean una versión particular de la obra.
Diferentes grupos de intérpretes generan distintas F2 Expressions de la misma F1 Work.
Cada instancia de F2 Expression, al ser ejecutada, da lugar a una o más F3 Manifestations (una por sesión de ejecución), entendidas como representaciones únicas y efímeras características del patrimonio cultural inmaterial.
Por su parte, las F5 Items representan los registros documentales de la obra.

F3 Manifestation y F5 Item son las clases más problemáticas, ya que sus definiciones están orientadas hacia registros bibliográficos, refiriéndose principalmente a publicaciones textuales (F3) y a copias de esas publicaciones (F5). No obstante, sus definiciones pueden adaptarse al ámbito de las artes escénicas, ofreciendo una perspectiva más amplia que debería reflejarse con mayor claridad en su formulación oficial.

Esta distinción entre Work, Expression, Manifestation e Item constituye la base de nuestra propuesta. En torno a ella orbitan el resto de las clases y propiedades.
Para describir otra información encontrada en el archivo que se vincula de diversas maneras con las clases WEMI, reutilizamos clases y propiedades de LRMoo y CIDOC CRM. Para los aspectos no cubiertos directamente por el modelo, se emplearon otros vocabularios.
